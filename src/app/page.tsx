...
import { Mail, Phone, Linkedin, MapPin, Download, Eye, ChevronDown, ChevronUp, Database, BarChart3, Code, Lightbulb, Users, Target, BookOpen, Briefcase, Award, Globe, Star } from 'lucide-react';
...
const CVKhadyThiam = () => {
  ...
  // GSAP animations
  // useEffect(() => {
  //   // Simuler le chargement GSAP
  //   const initializeGSAP = () => {
  //     if (typeof window !== 'undefined') {
  //       // Animation d'entrée du header
  //       const tl = {
  //         fromTo: (element, from, to, options = {}) => {
  //           if (element) {
  //             element.style.opacity = from.opacity || 1;
  //             element.style.transform = `translateY(${from.y || 0}px) scale(${from.scale || 1})`;

  //             setTimeout(() => {
  //               element.style.transition = 'all 0.8s cubic-bezier(0.4, 0, 0.2, 1)';
  //               element.style.opacity = to.opacity || 1;
  //               element.style.transform = `translateY(${to.y || 0}px) scale(${to.scale || 1})`;
  //             }, options.delay || 0);
  //           }
  //         },
  //         to: (element, options) => {
  ...
  // useEffect(() => {
  //   if (isLoaded) {
  //     const elements = document.querySelectorAll('.animate-section-change');
  ...
  const competences = [
    ...
    },
    {
      ...
      skills: ["Régressions", "ACP/ACM", "Analyses descriptives et exploratoires"],
    ...
    },
    {
      ...
      skills: ["ETL/ELT", "Nettoyage de données", "Transformation et automatisation"],
  ...
  const qualites = [
    { name: "Créativité", icon: <Lightbulb className="w-5 h-5" />, description: "Approche innovante des problèmes" },
    { name: "Adaptation", icon: <Target className="w-5 h-5" />, description: "Flexibilité face aux changements" },
    { name: "Relations", icon: <Users className="w-5 h-5" />, description: "Communication efficace" },
    { name: "Équipe", icon: <Users className="w-5 h-5" />, description: "Collaboration productive" },
    { name: "Résultats", icon: <Target className="w-5 h-5" />, description: "Focus sur les objectifs" }
  ];

  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/50 to-indigo-50/30 overflow-x-hidden">
      ...
      <div ref={headerRef} className="relative z-10  overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-20 left-32 w-24 h-1 bg-white/30"></div>
          <div className="absolute top-24 left-32 w-20 h-1 bg-white/25"></div>
          <div className="absolute top-28 left-32 w-16 h-1 bg-white/20"></div>

          <div className="absolute top-32 right-40 w-1 h-20 bg-white/20"></div>
          <div className="absolute top-32 right-36 w-1 h-16 bg-white/25"></div>
          <div className="absolute top-32 right-32 w-1 h-24 bg-white/30"></div>
        ...
        <div className="container mx-auto px-6 py-20 relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="group relative order-1 lg:order-1">
              <div className="w-56 h-56 rounded-full relative overflow-hidden group-hover:scale-105 transition-all duration-500 border-4 border-white/30 shadow-2xl ring-4 ring-white/10">
                <Image
            ...
            <div className="flex-1 text-center lg:text-left space-y-8 order-2 lg:order-2">
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-center lg:justify-start gap-3">
                  ...
                  <h2 className="text-3xl lg:text-4xl text-blue-200 font-light tracking-wide">
                    Data Analyst
                  </h2>
              ...
              <p className="text-slate-200 leading-relaxed max-w-4xl text-xl lg:text-xl font-light">
                Passionnée par la data science, je maîtrise la transformation des données en insights exploitables.
                Mon parcours académique et mes expériences m'ont permis d'acquérir de solides compétences en analyse et visualisation.
              </p>
              ...
              <div className="flex flex-wrap gap-4 justify-center lg:justify-start">
                <div className="px-6 py-3 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20 hover:bg-white/15 transition-all">
                  <span className="text-lg font-medium text-white">Python • R • SQL</span>
                </div>
                <div className="px-6 py-3 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20 hover:bg-white/15 transition-all">
                  <span className="text-lg font-medium text-white">PowerBI • Tableau</span>
                </div>
                <div className="px-6 py-3 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20 hover:bg-white/15 transition-all">
                  <span className="text-lg font-medium text-white">ETL • Visualisation</span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-5 bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20 shadow-xl order-3 lg:order-3">
              ...
              <div className="flex items-center gap-4 text-slate-200 hover:text-white transition-colors group">
                ...
                <span className="font-medium">linkedin.com/in/khady-thiam-10475b135</span>
              </div>
      ...
      {/* Navigation */}
      <div ref={navRef} className="sticky top-0 z-20 bg-white/90 backdrop-blur-xl border-b border-blue-100/50">
        <div className="container mx-auto px-6">
          <div className="relative">
            {/* Indicateur de section active */}
            <div
              className="absolute bottom-0 h-1 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-full transition-all duration-500 ease-in-out"
              style={{
                width: '120px',
                left: activeSection === 'experience' ? '20px' :
                      activeSection === 'competences' ? '160px' :
                      activeSection === 'formation' ? '300px' : '440px'
              }}
            ></div>

            <nav className="flex gap-2 py-3">
              {[
                { id: 'experience', label: 'Expérience', icon: <Briefcase className="w-5 h-5" />, color: 'from-blue-500 to-cyan-500' },
                { id: 'competences', label: 'Compétences', icon: <BarChart3 className="w-5 h-5" />, color: 'from-indigo-500 to-blue-500' },
                { id: 'formation', label: 'Formation', icon: <BookOpen className="w-5 h-5" />, color: 'from-sky-500 to-blue-500' },
                { id: 'qualites', label: 'Qualités', icon: <Award className="w-5 h-5" />, color: 'from-blue-600 to-indigo-600' }
              ].map((item) => (
                <button
                  key={item.id}
                ...
                >
                  {/* Fond dynamique pour la section active */}
                  {activeSection === item.id && (
                    <div className={`absolute inset-0 bg-gradient-to-br ${item.color} rounded-t-2xl shadow-lg`}></div>
                  )}

                  {/* Effet hover pour les sections inactives */}
                  {activeSection !== item.id && (
                  ...
                  <div className="relative z-10 flex flex-col items-center gap-2">
                    <div className={`p-2 rounded-xl transition-all duration-300 ${
                      ...
                      <div className={activeSection === item.id ? 'text-white' : 'text-slate-600 group-hover:text-blue-600'}>
                        {item.icon}
                      </div>
                    </div>
                  ...
                  {/* Particules flottantes pour la section active */}
                  {activeSection === item.id && (
                    <>
      ...
      {/* Content */}
      <div ref={contentRef} className="container mx-auto px-6 py-12 relative z-10">
        {/* Experience Section */}
              ...
              >
                ...
                <div className="ml-8 bg-white/70 backdrop-blur-sm rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 border border-sky-100 overflow-hidden group-hover:border-sky-300">
                  ...
                  >
                    <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                      <div className="flex-1 space-y-3">
                        <h4 className="text-2xl font-bold text-sky-800 group-hover:text-blue-700 transition-colors">{exp.title}</h4>
                        <div className="flex items-center gap-4">
                          <p className="text-xl text-sky-600 font-semibold">{exp.company}</p>
                      ...
                      <div className="flex items-center gap-3 group">
                        <span className="text-sm text-sky-500 font-medium">Voir détails</span>
                        <div className={`p-2 rounded-full bg-sky-100 group-hover:bg-sky-200 transition-all duration-300 ${expandedExperience[index] ? 'rotate-180' : ''}`}>
                  ...
                  {expandedExperience[index] && (
                    <div id={`exp-detail-${index}`} className="px-8 pb-8 border-t border-sky-100 bg-gradient-to-br from-sky-25 to-blue-25">
                      <div className="space-y-4 mt-6">
                        <h5 className="text-lg font-semibold text-sky-800 mb-4">Missions principales :</h5>
                        <div className="grid gap-3">
                          {exp.tasks.map((task, taskIndex) => (
                            <div key={taskIndex} className="flex items-start gap-4 p-4 bg-white/60 rounded-xl border border-sky-100 hover:border-sky-200 transition-colors group/task">
                              ...
                              <span className="text-sky-700 leading-relaxed">{task}</span>
                            </div>
                          ))}
                        </div>
                      </div>
              ...
              {competences.map((comp, index) => (
                <div key={index} className="animate-section-change group">
                  <div className="bg-white/70 backdrop-blur-sm rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 p-8 border border-sky-100 hover:border-sky-300 relative overflow-hidden">
                    <div className={`absolute top-0 left-0 right-0 h-1 bg-gradient-to-r ${comp.color}`}></div>

                    <div className="flex items-center gap-4 mb-6">
                      <div className={`p-3 rounded-xl bg-gradient-to-r ${comp.color} text-white shadow-lg group-hover:scale-110 transition-transform duration-300`}>
                        {comp.icon}
                      </div>
                      <h4 className="text-xl font-bold text-sky-800">{comp.category}</h4>
                    </div>

                    <div className="grid gap-3">
                      {comp.skills.map((skill, skillIndex) => (
                        <div key={skillIndex} className="flex items-center gap-3 p-3 bg-white/50 rounded-lg border border-sky-100/50 hover:border-sky-200 transition-all group/skill">
                          ...
                          <span className="text-sky-700 font-medium">{skill}</span>
                        </div>
                      ))}
                    </div>
                  </div>
          ...
          <div>
            ...
            <div className="space-y-6">
              {formations.map((formation, index) => (
                <div key={index} className="animate-section-change relative group">
                  ...
                  <div className="ml-16 bg-white/70 backdrop-blur-sm rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 p-8 border border-sky-100 hover:border-sky-300 relative">
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                      <div className="flex-1 space-y-3">
                        ...
                        <h4 className="text-2xl font-bold text-sky-800 group-hover:text-blue-700 transition-colors">{formation.title}</h4>
                        <p className="text-xl text-sky-600 font-semibold">{formation.school}</p>
                        {formation.location && (
              ...
              {qualites.map((qualite, index) => (
                <div key={index} className="animate-section-change group">
                  <div className="bg-white/70 backdrop-blur-sm rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 p-8 border border-sky-100 hover:border-sky-300 text-center relative overflow-hidden">
                    ...
                    <h4 className="text-xl font-bold text-sky-800 mb-2 group-hover:text-blue-700 transition-colors">{qualite.name}</h4>
                    <p className="text-sky-600 text-sm leading-relaxed">{qualite.description}</p>
                  </div>
                </div>
              ))}
            </div>
                ...
                <div className="animate-section-change group">
                  <div className="bg-white/70 backdrop-blur-sm rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 p-8 border border-sky-100 hover:border-sky-300">
                    <div className="flex items-center gap-4 mb-4">
                      ...
                      <h5 className="text-xl font-bold text-sky-800">Français</h5>
                    </div>
                    <div className="w-full bg-sky-100 rounded-full h-3 mb-2">
                      <div className="bg-gradient-to-r from-blue-500 to-cyan-500 h-3 rounded-full w-full shadow-sm"></div>
                    </div>
                    <span className="text-sm text-sky-600 font-medium">Langue maternelle</span>
                  </div>
                </div>
                ...
                <div className="animate-section-change group">
                  <div className="bg-white/70 backdrop-blur-sm rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 p-8 border border-sky-100 hover:border-sky-300">
                    <div className="flex items-center gap-4 mb-4">
                      ...
                      <h5 className="text-xl font-bold text-sky-800">Anglais</h5>
                    </div>
                    <div className="w-full bg-sky-100 rounded-full h-3 mb-2">
                      <div className="bg-gradient-to-r from-cyan-500 to-blue-500 h-3 rounded-full w-4/5 shadow-sm"></div>
                    </div>
                    <span className="text-sm text-sky-600 font-medium">Professionnel - 80%</span>
                  </div>
                </div>
              </div>
            </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sky-700 leading-relaxed">
                          Gestion de bases de données IA et coordination de projets
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white/70 backdrop-blur-sm rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 p-8 border border-sky-100 hover:border-sky-300 relative overflow-hidden">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sky-700 leading-relaxed">
                          Assistance pour les cours d'informatique (Excel, Python)
                        </p>
                      </div>
                    </div>
                  </div>
      ...
      {/* Footer */}
      <div className="relative z-10 bg-gradient-to-r from-blue-800 via-sky-700 to-indigo-800 text-white py-12 mt-20">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center space-y-4">
            ...
            <p className="text-xl font-light text-blue-100">
              © 2025 Khady Thiam - Data Analyst Experte
            </p>
